...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  void _calculateAgeAndBirthday() {
    ...
    if (_selectedMonth == now.month && _selectedDay == now.day) {
      setState(() {
        ...
        if (_currentLang == 'नेपाली') {
          _birthdayWishText = 'आज तपाईंको $formattedAgeNum औँ जन्मदिन हो! 🎂';
        } else if (_currentLang == 'नेपाल भाषा') {
          _birthdayWishText = 'थौं छगु $formattedAgeNum गःगु बुगुन्हि खः! 🎂';
        } else if (_currentLang == 'हिन्दी') {
          _birthdayWishText = 'आज आपका $formattedAgeNum वाँ जन्मदिन है! 🎂';
        } else if (_currentLang == 'اردو') {
          _birthdayWishText = 'آج آپ کی $formattedAgeNum ویں سالگرہ ہے! 🎂';
        } else {
          _birthdayWishText = 'Today is your $currentAgeYears${_getEnglishSuffix(currentAgeYears)} birthday! 🎂';
        }
      });
      _birthdayTimer?.cancel();
  ...
  String _getThaloUniqueWishText() {
    ...
    if (_selectedMonth > now.month || (_selectedMonth == now.month && _selectedDay > now.day)) {
      age--;
    }
    if (age < 0) age = 0;
    String ageStr = _getNumberOrWord(age, _currentLang);

    if (_currentLang == 'नेपाली') return 'थलो परिवारतर्फबाट यहाँलाई $ageStr औँ जन्मदिनको हार्दिक मंगलमय शुभकामना! ✨';
    if (_currentLang == 'हिन्दी') return 'थलो परिवार की ओर से आपको आपके $ageStr वाँ जन्मदिन की हार्दिक शुभकामनाएं! ✨';
    if (_currentLang == 'English') return 'Warmest wishes from the Thalo family on your $age${_getEnglishSuffix(age)} birthday! ✨';
    if (_currentLang == 'नेपाल भाषा') return 'थलो परिवारया तर्फबाट छयात $ageStr गःगु बुगुन्हिया तःधंगु भिंतुना! ✨';
    if (_currentLang == 'اردو') return 'تھلو فیملی کی طرف سے آپ کو $ageStr ویں سالگرہ کی مبارکباد! ✨';
          ...
          title: Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text('$_selectedCalendar | ${_selectedCalendar == 'AD' ? (_currentLang == 'नेपाली' ? 'लोकल' : 'Local') : 'AD'}', style: const TextStyle(color: Colors.blue, fontSize: 10)),
              ),
            ],
          ),
          content: SizedBox(
                    ...
                    items: List.generate(12, (i) => i + 1).map((m) {
                      ...
                      if (_selectedCalendar == 'AD') {
                        if (_currentLang == 'हिन्दी') {
                          name = ['जनवरी', 'फरवरी', 'मार्च', 'अप्रैल', 'मई', 'जून', 'जुलाई', 'अगस्त', 'सितंबर', 'अक्टूबर', 'नवंबर', 'दिसंबर'][m - 1];
                        } else {
                        ...
                        if (_currentLang == 'हिन्दी') {
                          name = ['वैशाख', 'ज्येष्ठ', 'आषाढ़', 'श्रावण', 'भाद्रपद', 'आश्विन', 'कार्तिक', 'मार्गशीर्ष', 'पौष', 'माघ', 'फागुन', 'चैत्र'][m - 1];
                        } else {
                          name = ['बैशाख', 'जेठ', 'आषाढ', 'श्रावण', 'भाद्र', 'आश्विन', 'कार्तिक', 'मंसिर', 'पुष', 'माघ', 'फागुन', 'चैत'][m - 1];
                        }
                      } else if (_selectedCalendar == 'هجری') {
                        name = ['محرم', 'صفر', 'ربیع الاول', 'ربیع الثانی', 'جمادی الاول', 'جمادی الثانی', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذوالقعدہ', 'ذوالحجہ'][m - 1];
                      } else {
                        name = _fmtNum(m);
                      }
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: AbsorbPointer(
                    child: TextField(
                      decoration: InputDecoration(
                        labelText: '${_getText('dob')} : ${_fmtNum(_selectedYear)}-${_fmtNum(_selectedMonth)}-${_fmtNum(_selectedDay)}',
                ...
                AnimatedSwitcher(
                  ...
                  child: Text(
                    _showThaloUniqueWish ? _getThaloUniqueWishText() : (_birthdayWishText.isEmpty ? '365 days remaining for your birthday.' : _birthdayWishText),
