class AppLocalizations {
  static const Map<String, Map<String, String>> localizedValues = {
    ...
    'اردو': {
      ...
      'errPhoneAlreadyInUse': 'یہ فون نمبر تھलो में पहले से رجسٹرڈ ہے۔ براہ کرم لاگ ان کریں۔ اگر آپ نیا تھलो اکاؤنٹ بنا رہے ہیں، تو براہ کرم کسی دوسرے فون نمبر یا جی میل اکاؤنٹ کے ساتھ دوبارہ کوشش کریں۔',
  ...
  static String formatNumber(int number, String currentLang, String selectedCalendar) {
    if (selectedCalendar == 'AD' || currentLang == 'English') {
      return number.toString();
    }
    String numStr = number.toString();
    if (currentLang == 'नेपाली' || currentLang == 'नेपाल भाषा') {
