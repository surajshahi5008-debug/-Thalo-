...
‎        context,
‎        MaterialPageRoute(builder: (context) => const ThaloNavigationScreen()), // एरर सुधार: यहाँबाट const हटाइयो
‎      );
‎    } catch (e) {
‎      if (!mounted) return;
...
‎                      TextButton(
‎                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const ThaloLoginScreen())), // एरर सुधार: यहाँबाट const हटाइयो
